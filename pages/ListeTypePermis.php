...
<?php
	...
	$offset=($page-1)*$size;
		...
		$resultat = $con->query("SELECT CODETYPEPERMIS, LIBELLETYPEPERMIS, LIMITEAGETYPEPERMIS, COUTFORMATIONTYPEPERMIS FROM typepermis
					...
					<div class="panel-body">
						...
						<div class="form-group">						
								...
								<?php if($_SESSION['utilisateur']['ROLE']=="ADMIN") {?>
									<a class="btn btn-success" href="NouveauPermisC.php">Ajouter Un Nouveau Permis de Conduire</a>
								<?php } ?>
							</div>
						</form>
					</div>
						...
						<table class="table table-striped">
							...
							<tbody>
								<?php while($STAGIAIRE=$resultat->fetch()){?>
									<tr>
										<td><?php echo $STAGIAIRE['CODETYPEPERMIS'] ?></td>
										...
										<td>
											<?php if($_SESSION['utilisateur']['ROLE']=="ADMIN") {?>
												...
												<a href="EditerTypeP.php?CODETYPEPERMIS=<?php echo $STAGIAIRE['CODETYPEPERMIS'] ?>">
													<span class="glyphicon glyphicon-pencil"></span>
												</a>
												
												&nbsp &nbsp
												<!--  Action Supprimer un stagiaire -->
												<a Onclick="return confirm('Etes Vous Sur de Vouloir Supprimer Ce Type de Permis ?')" 
													href="SupprimerTypeP.php?CODETYPEPERMIS=<?php echo $STAGIAIRE['CODETYPEPERMIS'] ?>">
