...
<?php
	...
	if($idf==0){// TOUTES LES FILIERES
		$resultat = $con->query("SELECT D.IDDEMANDECREDIT, C. NOMCLIENT, T.LIBELLETYPECREDIT, E.LIBELLEETATDEMANDE, D.DATEDEMANDECREDIT, D.HEUREDEMANDECREDIT, D.MONTANTDEMANDECREDIT
								FROM TYPECREDIT T, DEMANDECREDIT D, ETATDEMANDE E, CLIENT C
								WHERE T.CODETYPECREDIT = D.CODETYPECREDIT
								AND D.CODEETATDEMANDE = E.CODEETATDEMANDE
								AND D.REFERENCECLIENT = C.REFERENCECLIENT
...
<html>
	<head>
		<meta charset="utf-8" />
		<title>Page de Gestion des Demandes de Crédit - Demandes des Clients</title>
			...
			<div class="container">
				<div class="panel panel-success espace60">
					...
					<div class="panel-body">
						<form method="get" action="ListeDemandesCredit.php" class="form-inline">
				...
				<form class="form-inline" method="post" action="#">
					...
					<span class="glyphicon glyphicon-print" aria-hidden="true"></span> Imprimer La Liste des Demandes de Crédit</button>
				</form><br>
				<div class="panel panel-primary">
					<div class="panel-heading">
					
					Liste des Demandes de Crédit :  (<?php echo $nbrPro ?>&nbspDemandes (s) de Crédit Envoyées) 
					</div>
					<div class="panel-body">
									...
									<tr>
										...
										<td>
											<?php if($_SESSION['utilisateur']['ROLE']=="GestionnaireCompe") {?>
												...
												<a href="ListeGarantieC.php?IDDEMANDECREDIT=<?php echo $STAGIAIRE['IDDEMANDECREDIT'] ?>">
													<span class="glyphicon glyphicon-list-alt"></span> ListeGaranties
												</a>
								...
								<ul class="nav nav-pills nav-right">
									...
									<?php for($i=1;$i<=$nbrPage;$i++){ ?>
										<li class="<?php if($i==$page) echo 'active' ?>">
											<a href="ListeDemandesCredit.php?page=<?php echo $i ?>
											&motCle=<?php echo $mc ?>
