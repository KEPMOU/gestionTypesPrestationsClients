...
<html>
	...
	<body background="gestionVoyages7.JPG">
		 <div id="wrapper">
			...
			<div class="container">
				<div class="panel panel-success espace60">
					...
					<div class="panel-body">
						<form method="get" action="ListeVoyagesProg.php" class="form-inline">
						<div class="form-group">						
								<select name="CODEAGENCE" id="CODEAGENCE" class="form-control"
									onChange="this.form.submit();">
									<option value="ALL" >Voyages Par Agence</option>
								...
								&nbsp&nbsp&nbsp
									...
									<a class="btn btn-success" href="NouvelleRéservation.php">Envoyez Une Nouvelle Réservation</a>
									...
									<tr>
										...
										<td><?php echo $STAGIAIRE['IMMATRICULATIONBUS'] ?></td>
											...
											<?php {?>
												...
												<a href="ReserverV.php?REFERENCEVOYAGE=<?php echo $STAGIAIRE['REFERENCEVOYAGE'] ?>">
													<span class="glyphicon glyphicon-pencil"></span> RESERVER
												</a>
