	...
	<body>
		...
		<div class="container"><br>
			<div class="panel panel-primary espace60">
				<div class="panel-heading">Rechercher Un Compte Utilisateur</div>
			...
			<div class="panel panel-primary">
				<div class="panel-heading">Liste des Comptes Utilisateurs Enregistrés </div>
				<div class="panel-body">
					<table class="table table-striped">
						<thead>
							<tr>
								<th>ID du Compte</th>
								<th>Libellé du Compte Utilisateur</th>
			...
			<?php if($_SESSION['utilisateur']['ROLE']=="Administrateur") {?>
									<a class="btn btn-primary btn-lg btn-block" href="NouveauCompteUser.php">Ajouter Un Nouveau Compte Utilisateur dans La Base de Données</a>
								<?php } ?>	
